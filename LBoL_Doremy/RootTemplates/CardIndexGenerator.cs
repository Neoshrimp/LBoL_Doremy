...
namespace LBoL_Doremy.RootTemplates
{
    ...
    {
        private static readonly List<ManaColor> offColors = DoremyCavalierDef.offColors;
        private static int? initial_offset = null;
        private static HashSet<int> uniqueIds = new HashSet<int>() { };

        public const int milx10 = (int)1E7;
        ...
        public static int Initial_offset
        {
            get
            {
                if (initial_offset == null)
                {
                    ...
                    {
                        millions = indexSet.Where(i => i >= milx10).DefaultIfEmpty().Max() / milx10;
                    }
                    millions += 1;
                    initial_offset = millions * milx10;
                }
