...
It's defined in [url=https://github.com/Neoshrimp/LBoL_Doremy/blob/master/NoMetaScaling/Core/API/NoMetaScalinAPI.cs]'NoMetaScalinAPI'[/url] and meant to be used as a conditional dependency similar to [url=https://github.com/Neoshrimp/LBoL_Doremy/blob/master/NoMetaScaling/APIusageAsConditionalDependency.txt]Watermark[/url].


[b]Source code: [/b][url=https://github.com/Neoshrimp/LBoL_Doremy/tree/master/NoMetaScaling]github[/url].
...
'0.9.2' Update for LBoL 1.6.0 beta. [b]Not compatible with previous versions.[/b] Prevent All-Points Bulletin from scaling indefinitely.

'0.9.0' Exempt Remi bites, add persistent banning toggle to the API.

'0.8.1' Add Mushroom Specialist exception. Thanks again, [i]cyaneko[/i].

'0.8.0' Major ban rules overhaul. Thanks, [i]cyaneko[/i].
